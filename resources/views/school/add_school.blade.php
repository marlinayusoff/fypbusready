            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" action="/school" method="post"  id="contact_form">
                            	{{ csrf_field()}}
                                <h3>School Information</h3>
                                        ...
                                        <table class="table table-hover table-bordered text-center clearfix">
                                          ...
                                          <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control show-tick"  name="sekolah_sesi_petang">
                                                        <option value="Yes">Yes</option>
                                                        <option  value="No" selected>No</option>
                                                    </select>
                                                </td>
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <textarea rows="1" class="form-control no-resize auto-growth" name="sekolah_alamat" placeholder="Insert school address here"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="sekolah_tel" class="form-control" required>
