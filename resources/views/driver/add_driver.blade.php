            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_advanced_validation" action="/driver" method="post"  id="contact_form">
                            	{{ csrf_field()}}
                                <h3>Account Information</h3>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="pemandu_username" required>
                                            <label class="form-label">Username*</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="password" class="form-control" name="pemandu_password" id="password" required>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="pemandu_nama" class="form-control" required>
                                            <label class="form-label">Driver Name*</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="pemandu_tel" class="form-control" required>
                                            <label class="form-label">Telephone*</label>
                                        </div>
                                    </div>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="pemandu_noPlat" class="form-control" required>
                                            <label class="form-label">Num Plat*</label>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        <div class="col-md-11">
                                            <select class="form-control show-tick" name="sekolah_id">
